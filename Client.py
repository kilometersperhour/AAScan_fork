...
serverAddressList=["192.168.0.155"]    # Put your Phone IP here, multiple IPs are supported now (untested)!
serverPort=2021
bufferSize=12
nPhotos=180                      # How many photos do you want? (~180 for best quality)

serialConnection = serial.Serial('COM5',9600)   # Change this to COMx if you are on Windows, COMx is the port where Arduino serial is connected
